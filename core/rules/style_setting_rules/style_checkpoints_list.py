...
from core.utils.color_utils import get_basic_color_category
...
def get_all_style_checkpoints():
    return [
        ...
        StyleCheckPoint("Heading 1", "Font color should be blue-ish", lambda f, p: get_basic_color_category(f.Color) == "blue-ish"),
